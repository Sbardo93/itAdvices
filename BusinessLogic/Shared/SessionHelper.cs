...
#warning Check Session: TODO!
        ...
        //public static bool UtenteAbilitatoAllaManutenzione(string matricolaOperatore)
        //{
        //    bool retval = false;
        ...
        //        string[] AutorizzatiInManutenzione = new string[] { 
        //                                ""
        //                };

        //        foreach (string matricola in AutorizzatiInManutenzione)
        //        {

        //            if ((matricolaOperatore + string.Empty).Trim() == matricola)
        //            {
        //                retval = true;
        //                break;
        //            }
    ...
    public class SessionKeys
    {
        ...
        public static readonly SessionKeys Intervento = new SessionKeys("Intervento");
        ...
        public static readonly SessionKeys IdUtente = new SessionKeys("IdUtente");
        public static readonly SessionKeys LineaServizio = new SessionKeys("LineaServizio");
        public static readonly SessionKeys QuindicinaCorrente = new SessionKeys("QuindicinaCorrente");
        public static readonly SessionKeys UtenteSelezionatoTR = new SessionKeys("UtenteSelezionatoTR");
        public static readonly SessionKeys RuoloContrattoUtenteSelezionoTR = new SessionKeys("RuoloContrattoUtenteSelezionoTR");
        public static readonly SessionKeys SESSION_ALIVE = new SessionKeys("SESSION_ALIVE");
        public static readonly SessionKeys TipoErrore = new SessionKeys("TipoErrore");
        public static readonly SessionKeys GUID = new SessionKeys("GUID");
        public static readonly SessionKeys InterventiExport = new SessionKeys("InterventiExport");
        public static readonly SessionKeys TimeReportExport = new SessionKeys("TimeReportExport");
        public static readonly SessionKeys RipartizioneBudgetExport = new SessionKeys("RipartizioneBudgetExport");

        //GestioneStaffing
        public static readonly SessionKeys UtenteDaGestire = new SessionKeys("UtenteDaGestire");

        public static readonly SessionKeys SocietaContratto = new SessionKeys("SocietaContratto");
        public static readonly SessionKeys UtenteOriginale = new SessionKeys("UtenteSimulato");
        public static readonly SessionKeys SimulazioneAttiva = new SessionKeys("SimulazioneAttiva");
        ...
        //   {
        //       SessionHelper.Set(SessionKeys.ParametriTariffe,
        //           BusinessLogic.GestioneLineeServizio.GetParametriTariffe());
        //   }
        //);
