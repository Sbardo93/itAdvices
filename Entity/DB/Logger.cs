...
namespace ITAdvices.Entity.DB
{
    ...
    public class Logger
    {
        ...
        public static void LogErrore(string LogMessage)
        {
            WriteToLog("Unicarpe", LogMessage, EventLogEntryType.Error);
        }
        public static void LogWarning(string LogMessage)
        {
            WriteToLog("Unicarpe", LogMessage, EventLogEntryType.Warning);
        }
        public static void LogInfo(string LogMessage)
        {
            WriteToLog("Unicarpe", LogMessage, EventLogEntryType.Information);
        }
