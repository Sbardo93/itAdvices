<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucSmartGrid.ascx.cs" Inherits="ITAdvices.UserControls.ucSmartGrid" %>

<script src="<%=ResolveUrl("~/Scripts/datatables.min.js")%>" type="text/javascript"></script>
<script src="<%=ResolveUrl("~/Scripts/bootstrap.min.js")%>" type="text/javascript"></script>
<script src="<%=ResolveUrl("~/Scripts/bootstrap-toggle.js")%>" type="text/javascript"></script>
<link href="<%=ResolveUrl("~/Scripts/dataTables.min.css")%>" rel="stylesheet" />
<link href="<%=ResolveUrl("~/Scripts/bootstrap-toggle.css")%>" rel="stylesheet" />
<link href="<%=ResolveUrl("~/Scripts/font-awesome/css/font-awesome.css")%>" rel="stylesheet" />
<style type="text/css">
    #divSmartGrid {
        text-align: center;
